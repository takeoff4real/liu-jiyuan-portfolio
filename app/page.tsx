...
const masterProjects: MasterProject[] = [
  { number: '01', slug: 'idea9105', title: 'Interface Design', titleEn: 'IDEA9105', type: '第一学期 / FINAL WORK', year: '硕士课程 · 2025–2027', image: '/assets/masters/aussie-emergency/main.png', description: 'AUSSIE EMERGENCY：将灾害预警、行动指引与家庭协作整合为跨设备应急体验。', brief: '课程围绕界面设计的方法、结构与交互表达展开，要求将研究洞察转化为清晰、可用且可评估的数字界面方案。', required: true },
  { number: '02', slug: 'idea9106', title: 'Design Thinking', titleEn: 'IDEA9106', type: '第一学期 / FINAL WORK', year: '硕士课程 · 2025–2027', image: '/assets/masters/idea9106-final/page-01.jpg', description: 'Make Your Choice：面向国际学生的可持续饮品选择互动体验。', brief: '课程以设计思维为框架，强调从问题理解、用户洞察和概念生成出发，通过迭代形成有依据的最终设计提案。', required: true },
